      ...
      <section className="w-full px-4 md:px-12 py-8 md:py-16">
        <div className="space-y-6">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-3xl leading-relaxed">
            ...
            perspectives come together. Whether you're a designer with a vision,
            a founder with an idea, or a developer looking to collaborate, I'm
            always excited to explore new possibilities. Let's build something
            meaningful.
          </p>
        </div>
      </section>
