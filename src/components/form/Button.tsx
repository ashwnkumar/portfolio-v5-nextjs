...
const Button = ({
    ...
    const commonClasses =
        "group px-4 py-2 flex items-center rounded-md justify-center cursor-pointer font-medium active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed";
