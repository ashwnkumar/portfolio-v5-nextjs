...
const ProjectDetails = ({ projectId }: ProjectDetailsProps) => {
  ...
  return (
    <GridContainer>
      ...
      {/* Images */}
      <GridCard className="col-start-1 col-end-13 lg:col-end-9 row-start-2 row-end-5 lg:row-end-7 hover:!scale-100">
      ...
      {/* Overview */}
      <GridCard className="col-start-1 col-end-13 lg:col-end-5 row-start-12 row-end-15 lg:row-start-7 lg:row-end-10">
      ...
      {/* Stack */}
      <GridCard className="col-start-1 col-end-13 lg:col-start-5 lg:col-end-9 row-start-15 row-end-18 lg:row-start-7 lg:row-end-10">
        <StackCard stack={project.stack || []} />
      </GridCard>

      {/* Links */}
      {project.links && (
        <GridCard className="col-start-1 lg:col-start-9 col-end-13 row-start-11 row-end-12 lg:row-start-9 lg:row-end-10 !bg-bg !p-0 !shadow-none hover:!scale-100">
